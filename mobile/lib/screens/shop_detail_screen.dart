...
import 'dish_detail_screen.dart'; // Added import
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (ctx, i) {
                    ...
                    return InkWell( // Added InkWell for navigation
                      onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => DishDetailScreen(dish: item))),
                      child: Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Hero( // Added Hero for transition
                            tag: 'dish-${item.id}',
                            child: ClipRRect(
