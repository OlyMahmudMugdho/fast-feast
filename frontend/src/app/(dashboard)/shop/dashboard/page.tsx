...
import { ShoppingOutlined, DollarOutlined, TeamOutlined, EditOutlined } from '@ant-design/icons';
...
export default function ShopDashboard() {
  ...
  const fetchShopData = async () => {
    ...
    try {
      ...
      // Fetch employees
      const empRes = await api.get('/shops/me/employees');
  ...
  const columns = [
    ...
    { title: 'Customer', dataIndex: 'buyer_id', key: 'buyer', render: (id: string) => `User ${id.slice(0, 4)}` },
